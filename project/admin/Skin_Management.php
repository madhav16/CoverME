...
$sql="select * from test_skin order by id asc";
...
if($type=='delete')
{
    ...
    $delete_sql_status="delete from test_skin where id='$id'";
...
<nav class="navbar">
    ...
    <main>
        ...
        <h2 style="margin-top: 2rem; margin-bottom: 3rem;" ><a class="addbutton" style="text-decoration:none; transition: 400ms ease-in-out; color: white; padding: 1rem;margin: 1rem; background-color: rgb(83, 53, 81); border-radius: 5px;" href="add_skin.php">ADD more Skins</a></h2>
        <p><table class="table_class">
<tr class="headers">
<th id="pehla" style="padding-left:1rem" class="a head">ID</th>
<th class="a head">Category</th>
<th class="a head">Phone Name</th>
<th class="a head">Skin Name</th>
<th class="a head">Des Skin</th>
<th class="a head">Price</th>
...
<td class="a"><?php echo $row['s_name']?></td>
<td class="a"><?php echo $row['des_skin']?></td>
...
echo "&nbsp&nbsp<a style='text-decoration:none;color: #e26c48;text-shadow: 0px .5px 10px orangered;'href='Skin_Management.php?type=delete&id=".$row['id']."'>Delete</a>&nbsp";
echo "&nbsp&nbsp<a  style='text-decoration:none;color: white;text-shadow: 0px 1px 10px white' href='edit_skin.php?type=update&id=".$row['id']."'>Edit</a>&nbsp";
?></td>
</tr>
<?php }?>
</table></p>

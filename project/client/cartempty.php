...
<head>
    ...
    <title>Cart » dbrand</title>
    <!-- <link rel="stylesheet" href="styleop.css"> -->
    <link rel="stylesheet" href="style_L_-_Copy_-_Copy.css">
</head>
<body style="padding: 0;margin: 0;">
    <div class="seprater"></div>
    <div class="cartt" style ="margin-bottom: 0; background-color: black;color: #afafaf;border-bottom: 5px solid #ffbb00;">Cart</div>
    ...
    <main style=" height: 80vh; opacity: .7;  background-image: url(beck.png);" >
        ...
        <div style="display: flex; align-items: center; flex-direction: column; height: 100%;">
            <h1 style="font-size: 2rem; margin-top:10rem;">There is nothing currently in the cart.</h2>
            <div  style="margin-top: 2rem; background-color: #ffbb00; height: .1vh;width: 70vh;" class="seprater"></div>
            <h2 style="margin-top: 2rem;font-size: 1.3rem; margin-bottom: 2rem; ">It appears that your shopping cart is empty. We're eagerly awaiting your money.<br> Remember: the more you spend, the quicker we all get to buy Tesla's.</h2>
            <a onclick="window.history.back() " style="opacity: 1;  cursor: pointer;
